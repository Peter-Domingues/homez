  ...
  return (
    <div style={{ maxWidth: "200px", margin: "auto" }}>
      <blockquote
        ...
        data-instgrm-permalink="https://www.instagram.com/p/C6zrbcLLk0W/?utm_source=ig_embed&amp;utm_campaign=loading"
      ...
      >
        <div style={{ padding: "16px" }}>
          <a
            href="https://www.instagram.com/p/C6zrbcLLk0W/?utm_source=ig_embed&amp;utm_campaign=loading"
            style={{
              background: "#FFFFFF",
              lineHeight: 0,
              padding: 0,
          ...
          >
            <a
              ...
              rel="noopener noreferrer"
            >
              A post shared by Anastasia Benedeti (@anastasiab.realestate)
            </a>
          </p>
        </div>
      </blockquote>
